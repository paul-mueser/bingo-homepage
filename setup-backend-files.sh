...
sed -i "s|{{DB_HOST}}|${DB_HOST}|g" api/fetch-users.php
sed -i "s|{{DB_USER}}|${DB_USER}|g" api/fetch-users.php
sed -i "s|{{DB_PASS}}|${DB_PASSWORD}|g" api/fetch-users.php
sed -i "s|{{DB_NAME}}|${DB_NAME}|g" api/fetch-users.php
sed -i "s|{{JWT_SECRET}}|${JWT_SECRET}|g" api/fetch-users.php

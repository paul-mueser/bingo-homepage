    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <td class="content">
                    <button @click="updateEvent(event.id, true)" :disabled="console.log(event.amountbased && event.amounthappend >= event.amountneeded) || event.amountbased && event.amounthappend >= event.amountneeded">Add 1</button>

<template>
  <v-container class="game" style="margin-top: 50px;">
    <v-btn base-color="primary" variant="flat" v-on:click="loginMode = true" :disabled="loginMode" style="margin-right: 10px;">Login</v-btn>
    <v-btn base-color="primary" variant="flat" v-on:click="loginMode = false" :disabled="!loginMode">Register</v-btn>

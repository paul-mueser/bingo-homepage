<template>
  <v-container class="game" style="margin-top: 50px;">
    <v-btn v-on:click="loginMode = true" :disabled="loginMode" style="margin-right: 10px;" class="bg-primary">Login</v-btn>
    <v-btn v-on:click="loginMode = false" :disabled="!loginMode" class="bg-primary">Register</v-btn>
